...
namespace PaypalIntegrationDemo.Controllers.Paypal
{
    public class PDTHolder
    {
        ...
        public string BusnessEmail { get; set; }
        ...
        private static PDTHolder Parse(string postData)
        {
            ...
            try
            {
                ...
                {
                    string[] stringArray1 = postData.Split('=');
                    sKey = stringArray1[0];
                    ...
                    switch (sKey)
                    {
                        ...
                        case "mc_fee":
                            ...
                            break;
                        case "business":
                            ph.BusnessEmail = Convert.ToString(sValue);
                            break;
                        case "payer_email":
